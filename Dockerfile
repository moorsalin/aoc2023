# you can remove this file if it's not needed, but if you needed a customized
# runtime environment for your build task, you can use this as a starting point
